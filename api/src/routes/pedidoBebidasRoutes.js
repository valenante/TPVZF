...
const router = Router();
import { getPedidos, getPedidoById, getPedidosPendientes, getPedidosFinalizados, createPedido, updatePedido, updateProducto, deletePedido, agregarProductoAlPedido, verificarPedidosMesa } from '../controllers/pedidoBebidasController.js';
